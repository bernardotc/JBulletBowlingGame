...
public class JBulletDemoAppStarterForCE812  {
	public static void main(String[] args) {
		...
		switch(0) {
			...
			case 8:demoApp= new ConcaveConvexcastDemo(demoPanel.getGL());break;// doesn't work Not Instrumented Exception
			case 9:demoApp= new CharacterDemo(demoPanel.getGL());break;
