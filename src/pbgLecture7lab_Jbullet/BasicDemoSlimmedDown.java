...
public class BasicDemoSlimmedDown extends JBulletGame3d {
	...
	public void initPhysics() {
...

		{
			...
			CollisionShape colShape = new CylinderShape(new Vector3f(1, 2, 1));
	...
	public static void main(String[] args) {
		...
		final BasicDemoSlimmedDown demoApp = new BasicDemoSlimmedDown(panel3d.getGL(), panel3d);
	...
	private void startThread()  {
		...
		panel3d.requestFocusInWindow();
                CollisionShape colShape = new SphereShape(2f);
                collisionShapes.add(colShape);
                // Create Dynamic Objects
                Transform startTransform = new Transform();
                startTransform.setIdentity();
                ...
                Vector3f localInertia = new Vector3f(1, 1, 1);
                if (isDynamic) {
                        colShape.calculateLocalInertia(mass, localInertia);
                }
